                        ...
                        if(status.includes(xhr_cate.status)){
                            ...
                            ul.addEventListener('click',function(e){
                                ...
                                if(target.tagName.toLowerCase() === 'img'){
                                    ...
                                    var currentid = currentli.getAttribute("data-guid");
                                    console.log(currentid);
                                    location.href = "productdetail.html"+"?"+"currentid="+currentid;
                                };
                                if(target.tagName.toLowerCase()==='button'){
                                    ...
                                    if(i === carlist.length){                    
                                        var goods = {
                                            id:id,
                                            imgurl1:target.parentNode.children[0].src,
                                    ...
                                    var cloneimg = currentLi.children[0].cloneNode();
